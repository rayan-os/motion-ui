...
"[project]/components/orbit/orbit-demo.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const availableAgents = [
    {
        ...
        role: "AI Support",
        color: "#3B82F6",
        description: "Handle support tickets & emails"
    },
    {
        id: "jackie",
        name: "Jackie",
        role: "AI Counsellor",
        color: "#F97316",
        description: "Guide students to programs"
    },
    {
        id: "david",
        name: "David",
        role: "AI Processor",
        color: "#10B981",
        description: "Process documents & KYC"
    },
    {
        id: "ella",
        name: "Ella",
        role: "AI Interviewer",
        color: "#EAB308",
        description: "Conduct interviews & assess"
    }
];
const integrations = [
    {
            ...
            children: [
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("svg", {
                    ...
                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("path", {
                        ...
                        fileName: "[project]/components/orbit/orbit-demo.tsx",
                        lineNumber: 57,
                        columnNumber: 11
...
function OrbitDemo() {
    ...
    const [isDeployed, setIsDeployed] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "OrbitDemo.useEffect": ()=>{
            ...
            let cancelled = false;
            const click = {
                "OrbitDemo.useEffect.click": async ()=>{
                    setCursorClicking(true);
                    await new Promise({
                        "OrbitDemo.useEffect.click": (r)=>setTimeout(r, 80)
                    }["OrbitDemo.useEffect.click"]);
                    setCursorClicking(false);
                }
            }["OrbitDemo.useEffect.click"];
            const runDemo = {
                "OrbitDemo.useEffect.runDemo": async ()=>{
                    while(!cancelled){
                        // Reset
                        setCurrentStep(1);
                        setSelectedAgents([]);
                        ...
                        await new Promise({
                            "OrbitDemo.useEffect.runDemo": (r)=>setTimeout(r, 800)
                        }["OrbitDemo.useEffect.runDemo"]);
                        // Show cursor
                        setCursorVisible(true);
                        await new Promise({
                            "OrbitDemo.useEffect.runDemo": (r)=>setTimeout(r, 400)
                        }["OrbitDemo.useEffect.runDemo"]);
                        ...
                        await new Promise({
                            "OrbitDemo.useEffect.runDemo": (r)=>setTimeout(r, 300)
                        }["OrbitDemo.useEffect.runDemo"]);
                        // Click on Jackie
                        const jackiePos = getPos("agent-jackie");
                        if (jackiePos) setCursorPosition(jackiePos);
                        await new Promise({
                            "OrbitDemo.useEffect.runDemo": (r)=>setTimeout(r, 350)
                        }["OrbitDemo.useEffect.runDemo"]);
                        await click();
                        setSelectedAgents([
                            "mark",
                        ...
                        await new Promise({
                            "OrbitDemo.useEffect.runDemo": (r)=>setTimeout(r, 500)
                        }["OrbitDemo.useEffect.runDemo"]);
                        ...
                        setCurrentStep(2);
                        await new Promise({
                            "OrbitDemo.useEffect.runDemo": (r)=>setTimeout(r, 600)
                        }["OrbitDemo.useEffect.runDemo"]);
                        ...
                        setIsDeploying(true);
                        await new Promise({
                            "OrbitDemo.useEffect.runDemo": (r)=>setTimeout(r, 1500)
                        }["OrbitDemo.useEffect.runDemo"]);
                        setIsDeploying(false);
                        setCurrentStep(3);
                        setIsDeployed(true);
                        ...
                        await new Promise({
                            "OrbitDemo.useEffect.runDemo": (r)=>setTimeout(r, 3500)
                        }["OrbitDemo.useEffect.runDemo"]);
                    }
                }
            }["OrbitDemo.useEffect.runDemo"];
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$render$2f$components$2f$motion$2f$proxy$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["motion"].div, {
            ...
            children: [
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    className: "rounded-[8px] overflow-hidden bg-[#141414] border border-white/[0.08]",
                    style: {
                        boxShadow: "0 30px 100px rgba(0,0,0,0.5)"
                    },
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            className: "flex items-center justify-between px-5 py-3 bg-[#1a1a1a] border-b border-white/[0.06]",
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: [
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$render$2f$components$2f$motion$2f$proxy$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["motion"].button, {
                                                        ...
                                                        className: `px-5 py-2 rounded-[5px] text-[12px] font-medium transition-all ${connectedIntegrations.length > 0 ? "bg-[#10B981] text-white" : "bg-white/10 text-white/30"}`,
                                                        whileTap: {
                                                            scale: 0.97
                                                        },
                                                        children: isDeploying ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                            className: "flex items-center gap-2",
                                                            children: [
                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$render$2f$components$2f$motion$2f$proxy$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["motion"].div, {
                                    ...
                                    currentStep === 3 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$render$2f$components$2f$motion$2f$proxy$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["motion"].div, {
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: selectedAgents.map((agentId, idx)=>{
                                                    const agent = availableAgents.find((a)=>a.id === agentId);
                                                    if (!agent) return null;
                                                    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$render$2f$components$2f$motion$2f$proxy$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["motion"].div, {
                                                        ...
                                                        children: [
                                                            ...
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                ...
                                                                children: [
                                                                    ...
                                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                                        className: "text-[9px] text-[#10B981]",
                                                                        children: "Active"
                                                                    }, void 0, false, {
                                                                        fileName: "[project]/components/orbit/orbit-demo.tsx",
                                                                        lineNumber: 524,
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                className: "p-3 rounded-[6px] bg-white/[0.02] border border-white/[0.06]",
                                                children: [
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        className: "text-[10px] text-white/40 mb-2",
...
_s(OrbitDemo, "r0odC+nhF3FAfxQzVmMG8eLo1Nk=");
_c1 = OrbitDemo;
var _c, _c1;
__turbopack_context__.k.register(_c, "VirtualCursor");
__turbopack_context__.k.register(_c1, "OrbitDemo");
...
//# sourceMappingURL=components_orbit_orbit-demo_tsx_11fc36fa._.js.map