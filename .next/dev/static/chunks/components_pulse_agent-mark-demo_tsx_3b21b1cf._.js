...
"[project]/components/pulse/agent-mark-demo.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const ActionIcon = ({ type })=>{
    const icons = {
        doc: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("svg", {
            width: "12",
            height: "12",
            viewBox: "0 0 24 24",
            fill: "none",
...
function AgentMarkDemo() {
    ...
    const [actionProgress, setActionProgress] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(0);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AgentMarkDemo.useEffect": ()=>{
            ...
            let cancelled = false;
            const getPos = {
                "AgentMarkDemo.useEffect.getPos": (id)=>{
            ...
            }["AgentMarkDemo.useEffect.getPos"];
            const typeAndSend = {
                "AgentMarkDemo.useEffect.typeAndSend": async (text, messageIndex)=>{
                    // Type
                    for (const char of text.split("")){
                        if (cancelled) break;
                        setChatInput({
                            "AgentMarkDemo.useEffect.typeAndSend": (p)=>p + char
                        }["AgentMarkDemo.useEffect.typeAndSend"]);
                        await new Promise({
                            "AgentMarkDemo.useEffect.typeAndSend": (r)=>setTimeout(r, 35)
                        }["AgentMarkDemo.useEffect.typeAndSend"]);
                    }
                    await new Promise({
                        "AgentMarkDemo.useEffect.typeAndSend": (r)=>setTimeout(r, 200)
                    }["AgentMarkDemo.useEffect.typeAndSend"]);
                    // Send
                    ...
                    await new Promise({
                        "AgentMarkDemo.useEffect.typeAndSend": (r)=>setTimeout(r, 80)
                    }["AgentMarkDemo.useEffect.typeAndSend"]);
                    setCursorClicking(false);
                    setChatMessages({
                        "AgentMarkDemo.useEffect.typeAndSend": (prev)=>[
                                ...prev,
                    ...
                    setChatInput("");
                    await new Promise({
                        "AgentMarkDemo.useEffect.typeAndSend": (r)=>setTimeout(r, 300)
                    }["AgentMarkDemo.useEffect.typeAndSend"]);
                    // Mark responds
                    if (chatFlow[messageIndex + 1]) {
                        setIsTyping(true);
                        await new Promise({
                            "AgentMarkDemo.useEffect.typeAndSend": (r)=>setTimeout(r, 500)
                        }["AgentMarkDemo.useEffect.typeAndSend"]);
                        setIsTyping(false);
                        setChatMessages({
                            "AgentMarkDemo.useEffect.typeAndSend": (prev)=>[
            ...
            const runDemo = {
                "AgentMarkDemo.useEffect.runDemo": async ()=>{
                    while(!cancelled){
                        // Reset
                        setChatMessages([]);
                        setChatInput("");
                        ...
                        setActionProgress(0);
                        await new Promise({
                            "AgentMarkDemo.useEffect.runDemo": (r)=>setTimeout(r, 400)
                        }["AgentMarkDemo.useEffect.runDemo"]);
                        // Mark greeting
                        setChatMessages([
                            chatFlow[0]
                        ]);
                        await new Promise({
                            "AgentMarkDemo.useEffect.runDemo": (r)=>setTimeout(r, 800)
                        }["AgentMarkDemo.useEffect.runDemo"]);
                        // Show cursor
                        ...
                        await new Promise({
                            "AgentMarkDemo.useEffect.runDemo": (r)=>setTimeout(r, 300)
                        }["AgentMarkDemo.useEffect.runDemo"]);
                        ...
                        await new Promise({
                            "AgentMarkDemo.useEffect.runDemo": (r)=>setTimeout(r, 200)
                        }["AgentMarkDemo.useEffect.runDemo"]);
                        ...
                        setIsTyping(false);
                        setChatMessages({
                            "AgentMarkDemo.useEffect.runDemo": (prev)=>[
                                    ...prev,
                                    chatFlow[5]
                                ]
                        }["AgentMarkDemo.useEffect.runDemo"]);
                        await new Promise({
                            "AgentMarkDemo.useEffect.runDemo": (r)=>setTimeout(r, 600)
                        }["AgentMarkDemo.useEffect.runDemo"]);
                        ...
                        // Hold on resolved
                        await new Promise({
                            "AgentMarkDemo.useEffect.runDemo": (r)=>setTimeout(r, 3500)
                        }["AgentMarkDemo.useEffect.runDemo"]);
                    }
                }
            }["AgentMarkDemo.useEffect.runDemo"];
                                                                        ...
                                                                        children: [
                                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                                ...
                                                                                children: actionProgress > idx ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$render$2f$components$2f$motion$2f$proxy$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["motion"].svg, {
                                                                                    ...
                                                                                    lineNumber: 320,
                                                                                    columnNumber: 35
                                                                                }, this) : /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(ActionIcon, {
                                                                                    type: action.icon
                                                                                }, void 0, false, {
                                                                                    fileName: "[project]/components/pulse/agent-mark-demo.tsx",
                                                                                    lineNumber: 329,
...
_s(AgentMarkDemo, "8+p0IPEW/Fo7t+ZW7a9fuY8PDbQ=");
_c2 = AgentMarkDemo;
var _c, _c1, _c2;
__turbopack_context__.k.register(_c, "VirtualCursor");
__turbopack_context__.k.register(_c1, "ActionIcon");
__turbopack_context__.k.register(_c2, "AgentMarkDemo");
...
//# sourceMappingURL=components_pulse_agent-mark-demo_tsx_3b21b1cf._.js.map