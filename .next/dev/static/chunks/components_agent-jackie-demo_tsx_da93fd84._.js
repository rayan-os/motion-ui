...
"[project]/components/agent-jackie-demo.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
            ...
            children: [
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("svg", {
                    ...
                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("path", {
                        ...
                        fileName: "[project]/components/agent-jackie-demo.tsx",
                        lineNumber: 58,
                        columnNumber: 11
...
function AgentJackieDemo() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AgentJackieDemo.useEffect": ()=>{
            ...
            let cancelled = false;
            const getPos = {
                "AgentJackieDemo.useEffect.getPos": (id)=>{
            ...
            }["AgentJackieDemo.useEffect.getPos"];
            const typeAndSend = {
                "AgentJackieDemo.useEffect.typeAndSend": async (text, messageIndex)=>{
                    // Type
                    for (const char of text.split("")){
                        if (cancelled) break;
                        setChatInput({
                            "AgentJackieDemo.useEffect.typeAndSend": (p)=>p + char
                        }["AgentJackieDemo.useEffect.typeAndSend"]);
                        await new Promise({
                            "AgentJackieDemo.useEffect.typeAndSend": (r)=>setTimeout(r, 35)
                        }["AgentJackieDemo.useEffect.typeAndSend"]);
                    }
                    await new Promise({
                        "AgentJackieDemo.useEffect.typeAndSend": (r)=>setTimeout(r, 200)
                    }["AgentJackieDemo.useEffect.typeAndSend"]);
                    // Send
                    ...
                    await new Promise({
                        "AgentJackieDemo.useEffect.typeAndSend": (r)=>setTimeout(r, 80)
                    }["AgentJackieDemo.useEffect.typeAndSend"]);
                    setCursorClicking(false);
                    setChatMessages({
                        "AgentJackieDemo.useEffect.typeAndSend": (prev)=>[
                                ...prev,
                    ...
                    setChatInput("");
                    await new Promise({
                        "AgentJackieDemo.useEffect.typeAndSend": (r)=>setTimeout(r, 300)
                    }["AgentJackieDemo.useEffect.typeAndSend"]);
                    // Jackie responds
                    if (chatFlow[messageIndex + 1]) {
                        setIsTyping(true);
                        await new Promise({
                            "AgentJackieDemo.useEffect.typeAndSend": (r)=>setTimeout(r, 500)
                        }["AgentJackieDemo.useEffect.typeAndSend"]);
                        setIsTyping(false);
                        setChatMessages({
                            "AgentJackieDemo.useEffect.typeAndSend": (prev)=>[
            ...
            const runDemo = {
                "AgentJackieDemo.useEffect.runDemo": async ()=>{
                    while(!cancelled){
                        // Reset
                        setChatMessages([]);
                        setChatInput("");
                        ...
                        setIsTyping(false);
                        await new Promise({
                            "AgentJackieDemo.useEffect.runDemo": (r)=>setTimeout(r, 400)
                        }["AgentJackieDemo.useEffect.runDemo"]);
                        // Jackie greeting
                        setChatMessages([
                            chatFlow[0]
                        ]);
                        await new Promise({
                            "AgentJackieDemo.useEffect.runDemo": (r)=>setTimeout(r, 800)
                        }["AgentJackieDemo.useEffect.runDemo"]);
                        // Show cursor
                        ...
                        await new Promise({
                            "AgentJackieDemo.useEffect.runDemo": (r)=>setTimeout(r, 300)
                        }["AgentJackieDemo.useEffect.runDemo"]);
                        ...
                        await new Promise({
                            "AgentJackieDemo.useEffect.runDemo": (r)=>setTimeout(r, 200)
                        }["AgentJackieDemo.useEffect.runDemo"]);
                        ...
                        await new Promise({
                            "AgentJackieDemo.useEffect.runDemo": (r)=>setTimeout(r, 3000)
                        }["AgentJackieDemo.useEffect.runDemo"]);
                    }
                }
            }["AgentJackieDemo.useEffect.runDemo"];
...
_s(AgentJackieDemo, "nUk3Bd3v1f8ZcPwH6qTYD4auDjE=");
_c1 = AgentJackieDemo;
var _c, _c1;
__turbopack_context__.k.register(_c, "VirtualCursor");
__turbopack_context__.k.register(_c1, "AgentJackieDemo");
...
//# sourceMappingURL=components_agent-jackie-demo_tsx_da93fd84._.js.map